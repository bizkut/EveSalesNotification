...
def callback():
    ...
    if success:
        ...
        if is_new:
            ...
            # If the character is not new, it's a re-authentication.
            # Trigger the task that handles "welcome back" messages and permission updates.
